...
glactools:	glactools.o GlacIndex.o GlacWriter.o Vcf2ACF.o Vcf2GLF.o AlleleRecords.o SingleAllele.o SingleGL.o GlacViewer GlacParser VCFreader.o SimpleVCF.o CoreVCF.o ReadTabix.o SetVCFFilters.o FilterVCF.o glactoolsOperations.o tabixpp/tabix.o htslib/libhts.a ${LIBGAB}/utils.o  libgab//gzstream/gzstream.o
