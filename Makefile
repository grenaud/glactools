...
CXXFLAGS = -Wall -lm -O3 -lz -Ihtslib/ -Isamtools/ -Itabixpp/ -Ilibgab/ -Ilibgab/gzstream/ -c #-Ibamtools/include/ -Ibamtools/src/
...
all: libgab/utils.o tabixpp/tabix.o samtools/bedidx.o glactools 
