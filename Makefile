...
CXX      = g++ -std=c++11 #-g  # -fstack-protector -g -pg 
#LIBGAB   = libgab/
...
lib/libglactools.a: GlacIndex.o GlacIDXSTATS.o GlacWriter.o MultiVCFreader.o GLF2ACF.o VcfMulti2ACF.o T3andme2ACF.o AXT2ACF.o Vcf2ACF.o Vcf2GLF.o  SingleAllele.o BAM2ACF.o EIGENSTRAT2ACF.o BEAGLE2GLF.o BPLINK2ACF.o AlleleRecords.o SingleGL.o GlacUndef.o GlacSegsite.o GlacRename.o GlacSharing.o GlacNoSharing.o GlacNoStrictSharing.o GlacNosingle.o GlacBedfilter.o Glac2FREQSPEC.o Glac2BED.o ACF2BPLINK.o ACF2FASTA.o ACF2GPHOCS.o ACF2NEXUS.o ACF2TREEMIX.o ACF2EIGENSTRAT.o GlacViewer.o GlacParser.o GlacStats.o GlacReplaceAncestor.o GlacUsePopAsRootAnc.o GlacCAT.o VCFreader.o SimpleVCF.o CoreVCF.o ReadTabix.o SetVCFFilters.o GlacMeld.o GlacDown.o GlacPopsub.o GlacCompute.o SumStatD.o DstatResult.o DstatCounter.o Dstat_core.o  SumStatAvgCoa.o AvgCoaAlleleCounter.o AvgCoaResult.o ComputeAvgCoa_core.o ComputeFst_core.o DistAlleleCounter.o DistResult.o SumStatDist.o ComputeDist_core.o FstAlleleCounter.o FstResult.o SumStatFst.o GlacClosest.o GlacRemovepop.o GlacIntersect.o GlacUnion.o GlacReheader.o FilterVCF.o GlactoolsOperations.o GenomicRange.o tabixpp/tabix.o libgab/utils.o  bamtools/build/src/utils/CMakeFiles/BamTools-utils.dir/*cpp.o libgab/gzstream/gzstream.o
